...
<!-- This might be a good place to bring in some comparisons with pikeminnow densities from the Columbia, put our numbers in context. -->
...
<!-- If catching and marking fish makes them want to leave the Deadwater area (more than unmarked fish), that could be making our estimates biased high (due to fewer recaptures). I don't imagine that is happening, but does anyone else have concerns about that?  -->
...
# summarze potential Chinook eaten for each timeperiod by one pikeminnow
...
* Maybe a plot of multiple scenarios depending on gastric lavage results? 

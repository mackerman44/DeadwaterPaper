...
```{r juv-con-p, fig.cap = "Estimated number of juvenile Chinook Salmon consumed by Northern Pikeminnow from a sensitivity analysis of variable diet scenarios. The proportion of Chinook Salmon in the total fish prey consumed by Northern Pikeminnow were evaluated for 30%, 50%, and 65% scenarios, similar to those reported by Zimmerman and Ward 1999."}

...
Four different mark-recapture abundance estimators were employed to explore variation in estimates among them. Estimators fell into two broad categories: single-census and multiple-census. For the single census estimators, we treated the first week of sampling as the mark event, and the following (second) week as the recapture week, pooling data within each of those weeks. Alternatively, the multiple census estimators treat each day as a sampling occassion, and use information about the total marked fish from all previous occassions to infer the total abundance. 

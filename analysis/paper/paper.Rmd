...
```{r cmr-effort-data}
cmr_df = read_csv(paste0(nas_prefix, "/data/fish/deadwater/deadwater_cmr_effort_20210614.csv")) %>%
  clean_names()
...
```{r temp-data}
temp_df = read_delim(paste0(nas_prefix,
                            "/data/temperature/deadwater/USGS_13307000_Salmon_River_Nr_Shoup.txt"),
                     delim = "\t",
                     comment = "#") %>%

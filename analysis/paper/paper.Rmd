...
impact_p = impact_df %>%
  ...
  ggplot(aes(x = perc_diet,y = N, group=as.factor(perc_chnk), linetype=as.factor(perc_chnk))) +
  geom_line(size = 1.05)+
  scale_y_continuous(labels = scales::comma) +
  scale_x_continuous(breaks = seq(0, 100, by = 10)) +
  scale_linetype_manual(name="Percent juvenile chinook \nof total fish consumed", values=c("dotted","solid","dashed"))+

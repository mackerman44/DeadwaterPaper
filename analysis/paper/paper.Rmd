...
The Deadwater Slough is an approximately two-kilometer (km) section of the mainstem Salmon River locations roughly 5.8 river kms downstream from the town of North Fork, Idaho ***(publication quality map referenced here)***. The downstream end of the Deadwater Slough is located at the confluence of Dump Creek and the Salmon River. Around 1897, the failure of a small mining diversion reservoir in the Dump Creek drainage resulted in an erosion event that deposited substantial amounts of sediment at the confluence of the Salmon River and Dump Creek [@Emerson1973]. The influx of sediment created a delta that impeded flow of the Salmon River, thereby creating an unnaturally slow and deep section in the river, spanning approximately 25.3 acres. The slower water velocities, deepened channel, and (anecdotally) warmer water temperatures favor piscivorous fishes known to occupy the reach (e.g., northern pikeminnow *Ptychocheilus oregonensis*, smallmouth bass *Micropterus dolomieu*).

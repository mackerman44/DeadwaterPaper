...
<!--If that assumption is not true and capture probability did differ, we believe that the capture probability  in the spring would be lower due to higher flows, which would lead to our spring abundance estimate to be biased low. Therefore, we presume our abundance estimate of Northern Pikeminnow for the spring 2021 sampling event to be a conservative estimate.-->
...
```{r fall-bio-fig, eval = F, fig.cap = "First bioenergetics plot."}
...
```{r full-yr-ng-fig, eval = F, fig.cap = "Next bioenergetics plot."}
...
```{r adult-imp-p, eval = F, fig.cap = "The adult impacts plot."}
adult_impact %>%
  mutate(stage = "Smolt") %>%

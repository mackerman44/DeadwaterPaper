...
bio_tbl = bio_g_summ %>%
  ...
  rename(Season = season,
         `Percent Fish in Diet` = name,
         `g Fish Consumed` = cumm_g) %>%
...
gastric_tbl %>%
  ...
  kable(booktabs = T,
        format.args = list(big.mark = ","),
        caption = "Counts of the total number of Northern Pikeminnow captured, gastric lavaged, individuals with stomach contents, and individuals with fish prey contents.") %>%
  kable_styling()

...
Our estimated consumption of Chinook Salmon juveniles by Northern Pikeminnow was calculated using a static predator population. If we assume an average juvenile Upper Salmon MPG Chinook Salmon of 10.6 g, this equates to 0.84 juvenile Chinook Salmon (range 0.43 – 0.94) under the 10% scenario and 2.11 juvenile Chinook Salmon (range 1.07 – 2.37) under the 25% scenario. Let’s now consider a stable Northern Pikeminnow population size of 10,000 (roughly the mean of fall and spring abundance estimates, divided by two to account for half of marked individuals not being available for recapture). In this case, the Northern Pikeminnow population in Deadwater Slough would be estimated to consume 8,400 (range 4,300 – 9,400) or 21,100 (range 10,700 – 23,700) under the 10% and 25% scenarios, respectively.
